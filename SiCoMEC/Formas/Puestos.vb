...
Public Class Puestos
    ...
    Private Sub Button_Borrar_Click(sender As Object, e As EventArgs) Handles Button_Borrar.Click
        ...
        Else
            Try
                Cx.Open()
                Dim SQL_Str As String = "Delete from Puestos where Id_Puesto = @Id_Area"
                Dim Cmd_Borra As SqlCommand = New SqlCommand(SQL_Str, Cx)
                Cmd_Borra.CommandType = CommandType.Text
                Cmd_Borra.Parameters.AddWithValue("@Id_Area", ID)
    ...
    Sub Guarda_Datos()
        ...
        SQL_Str = "Insert into Puestos (Descripcion) Values (@Area)"
        Try
            Cx.Open()
            Dim Cmd As New SqlCommand(SQL_Str, Cx)
            Cmd.CommandType = CommandType.Text
            Cmd.Parameters.AddWithValue("@Area", Serie)
            Cmd.ExecuteNonQuery()
